...
class Approach3 {
	...
	{
		FILENAME = "/Users/isabel/Desktop/Test_Cases/1000_Nodes_1000_Ports.txt";
		...
		totalCost += netCost;
		System.out.print(totalCost + "hello");
		System.out.println("Time taken in milli seconds: "+ (millis_endTime - millis_startTime)); 
		totalTime += millis_endTime - millis_startTime;
		System.out.print(totalTime + "hello1");
